...
export function GhMascot3D({
  ...
  spinRef: SpinRef
  /**
   * Strength of the back-lights that pick out the silhouette. Defaults to 0 (plain
   * key and fill lighting); the site mascot passes its own value.
   *
