...
import {
  ...
  type Dock,
  type Side,
} from "@/features/mascot/docks"
import { getPerch, type Perch } from "@/features/mascot/perch"
import { FACING_FORWARD_X } from "@/features/mascot/pose"
...
export function HomeMascot({
   ...
   * components, which cannot hold a ref (see features/mascot/page-mascot.tsx).
   */
  heroSlotId?: string
  /**
  ...
  return (
    <>
      {/*
        ...
        This used to be a separate glow component in the root layout, which found the
