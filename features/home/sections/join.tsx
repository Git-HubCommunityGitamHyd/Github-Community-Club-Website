 ...
 * stack inside a translucent slab with an animated particle headline that was
 * also the only way to reach the form; the form below it was a single narrow column
