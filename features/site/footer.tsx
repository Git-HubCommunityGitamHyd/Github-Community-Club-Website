...
import { PAGE_LINKS } from "@/features/site/nav"

// Homepage sections, as `/#id` so they work from every page: on the homepage
// Next treats it as a hash change and scrolls, anywhere else it navigates
// home first. Six entries sit as a tidy 2x3 block. Projects is not here
// because it has its own page, listed under Pages.
const SECTION_LINKS = [
  "About",
  "Journey",
  "Board",
    ...
    <footer className="border-t border-gh-border bg-gh-deep text-gh-text">
      <div className="mx-auto max-w-7xl px-4 pb-14 pt-20 sm:px-6 lg:px-8">
        ...
        <div className="mt-16 flex flex-col-reverse items-start gap-6 border-t border-gh-border pt-7 sm:flex-row sm:items-center sm:justify-between">
          ...
          {/* A real anchor, not a scripted button, so it survives
              middle-click and keyboard. `#top` is the spec's name for the
              top of the document, so it works on pages with no hero. */}
          <a
            href="#top"
